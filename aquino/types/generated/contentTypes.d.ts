...
export interface ApiMedicineCategorieMedicineCategorie
  ...
  attributes: {
    CategoryName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ControlledSubstance: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    RequirePrescription: Schema.Attribute.Boolean & Schema.Attribute.Required;
    StorageRequirements: Schema.Attribute.Blocks & Schema.Attribute.Required;
    SubCategory: Schema.Attribute.Component<'sub-category.sub-category', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMedicineMedicine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DosageForm: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    Manufacturer: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiPurchaseOrderLinePurchaseOrderLine
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    LineTotal: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::purchase-order-line.purchase-order-line'
    ...
    >;
    QuantityOrdered: Schema.Attribute.Integer & Schema.Attribute.Required;
    ReceivedStatus: Schema.Attribute.String & Schema.Attribute.Required;
    SubOrderLine: Schema.Attribute.Component<
      'sub-oderline.sub-order-line',
      true
    >;
    UnitPriceOrder: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    ...
    purchase_order_lines: Schema.Attribute.Relation<
      ...
      'api::purchase-order-line.purchase-order-line'
    >;
    ReceivedDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    SubOrders: Schema.Attribute.Component<'sub-order.sub-order', true>;
...
export interface ApiStockInventoryStockInventory
  ...
  attributes: {
    ...
    LastRestockDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::stock-inventory.stock-inventory'
    ...
    StorageLocation: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    LicenseNumber: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
